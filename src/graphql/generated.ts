...
export type CreateSubcriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubcriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSubcriberDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreateSubcriberMutationFn = Apollo.MutationFunction<CreateSubcriberMutation, CreateSubcriberMutationVariables>;

/**
 * __useCreateSubcriberMutation__
 *
 * To run a mutation, you first call `useCreateSubcriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubcriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubcriberMutation, { data, loading, error }] = useCreateSubcriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubcriberMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubcriberMutation, CreateSubcriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubcriberMutation, CreateSubcriberMutationVariables>(CreateSubcriberDocument, options);
      }
export type CreateSubcriberMutationHookResult = ReturnType<typeof useCreateSubcriberMutation>;
export type CreateSubcriberMutationResult = Apollo.MutationResult<CreateSubcriberMutation>;
export type CreateSubcriberMutationOptions = Apollo.BaseMutationOptions<CreateSubcriberMutation, CreateSubcriberMutationVariables>;
